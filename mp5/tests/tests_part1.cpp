...
TEST_CASE("KDTree::testSmallerDimVal Tests", "[weight=1][part=1]") {
  ...
  REQUIRE( tree1.smallerDimVal(a, b, 0) == true );
  REQUIRE( tree1.smallerDimVal(a, b, 2) == false );
  REQUIRE( tree1.smallerDimVal(a, b, 1) == true );
  REQUIRE( tree2.smallerDimVal(a, b, 0) == true );
  REQUIRE( tree2.smallerDimVal(a, b, 2) == false );
  REQUIRE( tree2.smallerDimVal(a, b, 1) == true );
}

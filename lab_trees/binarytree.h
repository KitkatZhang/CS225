...
class BinaryTree
{
    public:
        ...
        void isOrderedRecursivehelper(Node *& subRoot, T * &temp, bool & judge) const;
        ...
        void getPathshelper(Node *& subRoot, vector< T > v, vector<vector<T> > &paths) const;
        ...
        int sumDistanceshelper(Node *& subRoot, int level) const;
